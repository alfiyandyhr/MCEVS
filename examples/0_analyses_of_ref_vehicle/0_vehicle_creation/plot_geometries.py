...
plot_geometries(vehicle_list, label_list, cruise_speed_list, figname='multirotor_geom', savefig=False)

vehicle_list = [vehicle2]
label_list = ['baseline']
cruise_speed_list = [241.0]

plot_geometries(vehicle_list, label_list, cruise_speed_list, figname='liftcruise_geom', savefig=False)
