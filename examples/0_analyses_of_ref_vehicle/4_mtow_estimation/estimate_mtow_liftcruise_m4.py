...
print('\n--- Sanity Check: Structure Weights ---')
print('Fuselage weight = ', results.get_val('Weight|structure|fuselage'))
print('Wing weight = ', results.get_val('Weight|structure|wing'))
print('Booms weight = ', results.get_val('Weight|structure|booms'))
if fidelity['weight_model']['structure'] == 'Roskam':
	print('HTail weight = ', results.get_val('Weight|structure|horizontal_tail'))
	print('VTail weight = ', results.get_val('Weight|structure|vertical_tail'))
if fidelity['weight_model']['structure'] == 'M4Regression':
	print('Empennage weight = ', results.get_val('Weight|structure|empennage'))
...
if fidelity['power_model']['hover_climb']==2: print(f"LiftRotor|HoverClimb|thrust_residual_square = {results.get_val('LiftRotor|HoverClimb|thrust_residual_square')[0]}")
