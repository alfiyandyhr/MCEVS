...
if run_with_speed_as_design_var_one_opt:
    ...
    with warnings.catch_warnings():
        ...
        results = RunStandardSingleObjectiveOptimization(vehicle, mission_ij, fidelity, 'mission_time', mtow_guess, speed_as_design_var=True, print=True)
        print(results)
...
if run_with_speed_as_design_var_all_opt:
    ...
    for i, mission_range in enumerate(range_array):
        ...
        with warnings.catch_warnings():
            warnings.simplefilter("ignore")
            results = RunStandardSingleObjectiveOptimization(vehicle, mission_ij, fidelity, 'mission_time', mtow_guess, speed_as_design_var=True, print=False)
            # print(results)
