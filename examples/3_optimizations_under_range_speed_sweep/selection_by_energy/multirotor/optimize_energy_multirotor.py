	...
	for i, mission_range in enumerate(range_array):
		for j, cruise_speed in enumerate(speed_array):
			...
			if battery_energy_density == 250:
				if mission_range == 60 and cruise_speed == 100: mtow_guess = 5000.0
				if mission_range == 30 and cruise_speed in [140,280,290]: mtow_guess = 1500.0
				if mission_range == 70 and cruise_speed == 140: mtow_guess = 2500.0
				if mission_range == 40 and cruise_speed == 170: mtow_guess = 1500.0
				if mission_range == 130 and cruise_speed == 200: mtow_guess = 1500.0
				if mission_range == 70 and cruise_speed == 230: mtow_guess = 1500.0
				if mission_range == 150 and cruise_speed == 270: mtow_guess = 1500.0
				if mission_range == 80 and cruise_speed == 300: mtow_guess = 1500.0
				if mission_range == 40 and cruise_speed == 300: mtow_guess = 2500.0
			elif battery_energy_density == 400:
				if mission_range == 40 and cruise_speed == 200: mtow_guess = 1500.0
				if mission_range in [110,160] and cruise_speed == 260: mtow_guess = 1500.0
				if mission_range in [160,180,210] and cruise_speed == 300: mtow_guess = 1500.0
			elif battery_energy_density == 550:
				if mission_range == 130 and cruise_speed == 80: mtow_guess = 1500.0
				if mission_range == 140 and cruise_speed == 80: mtow_guess = 4000.0
				if mission_range == 170 and cruise_speed == 90: mtow_guess = 4500.0
				if mission_range in [180,190,200] and cruise_speed == 100: mtow_guess = 1500.0
				if mission_range == 80 and cruise_speed == 130: mtow_guess = 1500.0
				if mission_range == 20 and cruise_speed == 150: mtow_guess = 1500.0
				if mission_range == 70 and cruise_speed == 170: mtow_guess = 1500.0
				if mission_range == 130 and cruise_speed == 190: mtow_guess = 1500.0
				if mission_range == 220 and cruise_speed == 230: mtow_guess = 1500.0
				if mission_range == 190 and cruise_speed == 300: mtow_guess = 1500.0
...
if rerun_without_speed_as_design_var_all_opt:
	...
	for i, mission_range in enumerate(range_array):
		for j, cruise_speed in enumerate(speed_array):
			...
			if mission_range in [190] and cruise_speed == 300:
				iter_idx = i*len(speed_array)+j+1
				print(f"Iter= {iter_idx}, Range= {mission_range}, Speed= {cruise_speed}")
				sys.stdout.flush() # To flush the above print output
...
if run_with_speed_as_design_var_all_opt:
	...
	for i, mission_range in enumerate(range_array):
		...
		if battery_energy_density == 250:
			if mission_range in [90]: mtow_guess = 1500.0
			elif mission_range in [150]: mtow_guess = 900.0
			else: mtow_guess = 1000.0
		elif battery_energy_density == 400:
			if mission_range in [180]: mtow_guess = 900.0
			else: mtow_guess = 1000.0
		elif battery_energy_density == 550:
			mtow_guess = 1000.0
