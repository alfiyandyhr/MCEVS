	...
	for i, mission_range in enumerate(range_array):
		for j, cruise_speed in enumerate(speed_array):
			...
			if battery_energy_density == 250:
				if mission_range == 40 and cruise_speed == 130: mtow_guess = 1500.0
				if mission_range == 60 and cruise_speed == 140: mtow_guess = 1500.0
				if mission_range in [70,90,100] and cruise_speed == 150: mtow_guess = 1500.0
				if mission_range in [80,90,130,150] and cruise_speed == 160: mtow_guess = 1500.0
				if mission_range in [130,140,180] and cruise_speed == 170: mtow_guess = 1500.0
				if mission_range in [150,190,210,220] and cruise_speed == 180: mtow_guess = 1500.0
				if mission_range in [180,190,200,210,220] and cruise_speed == 190: mtow_guess = 1500.0
				if mission_range in [190,200,210] and cruise_speed == 200: mtow_guess = 1500.0
				if mission_range in [110] and cruise_speed == 250: mtow_guess = 1500.0
			elif battery_energy_density == 400:
				if mission_range in [120,130] and cruise_speed == 130: mtow_guess = 1500.0
				if mission_range in [150,160] and cruise_speed == 140: mtow_guess = 1500.0
				if mission_range in [180,200,210,220] and cruise_speed == 150: mtow_guess = 1500.0
			elif battery_energy_density == 550:
				if mission_range in [190,200,210] and cruise_speed == 130: mtow_guess = 1500.0
				if mission_range in [10] and cruise_speed == 160: mtow_guess = 1500.0
				if mission_range in [20] and cruise_speed == 170: mtow_guess = 1500.0
				if mission_range in [30] and cruise_speed == 180: mtow_guess = 1500.0
				if mission_range in [40] and cruise_speed == 190: mtow_guess = 1500.0
				if mission_range in [20,50] and cruise_speed == 200: mtow_guess = 1500.0
				if mission_range in [40,50,60] and cruise_speed == 210: mtow_guess = 1500.0
				if mission_range in [60,80] and cruise_speed == 220: mtow_guess = 1500.0
				if mission_range in [80] and cruise_speed == 230: mtow_guess = 1500.0
				if mission_range in [60] and cruise_speed == 240: mtow_guess = 1500.0
				if mission_range in [80,100] and cruise_speed == 250: mtow_guess = 1500.0
				if mission_range in [90] and cruise_speed == 280: mtow_guess = 1500.0
				if mission_range in [50,80] and cruise_speed == 290: mtow_guess = 1500.0
				if mission_range in [70] and cruise_speed == 310: mtow_guess = 1500.0
