    ...
    for i, mission_range in enumerate(range_array):
        for j, cruise_speed in enumerate(speed_array):
            ...
            if battery_energy_density == 250:
                if mission_range in [20, 30, 50] and cruise_speed == 80:
                    mtow_guess = 1500.0
                if mission_range in [50] and cruise_speed == 90:
                    mtow_guess = 1500.0
                if mission_range in [60] and cruise_speed == 90:
                    mtow_guess = 7000.0
                if mission_range in [30] and cruise_speed == 100:
                    mtow_guess = 1500.0
                if mission_range in [140] and cruise_speed == 240:
                    mtow_guess = 1500.0
                if mission_range in [130, 160] and cruise_speed == 250:
                    mtow_guess = 1500.0
                if mission_range in [110, 120] and cruise_speed == 260:
                    mtow_guess = 1500.0
                if mission_range in [100, 130, 140] and cruise_speed == 270:
                    mtow_guess = 1500.0
                if mission_range in [130, 150] and cruise_speed == 290:
                    mtow_guess = 1500.0
                if mission_range in [110, 120, 130, 150] and cruise_speed == 300:
                    mtow_guess = 1500.0
                if mission_range in [120] and cruise_speed == 310:
                    mtow_guess = 1500.0
                if mission_range in [130] and cruise_speed == 320:
                    mtow_guess = 1500.0
            elif battery_energy_density == 400:
                if mission_range == 120 and cruise_speed == 90:
                    mtow_guess = 2500.0
                if mission_range == 70 and cruise_speed == 120:
                    mtow_guess = 1500.0
                if mission_range == 60 and cruise_speed == 130:
                    mtow_guess = 1500.0
                if mission_range == 200 and cruise_speed == 310:
                    mtow_guess = 1500.0
            elif battery_energy_density == 550:
                if mission_range == 140 and cruise_speed == 80:
                    mtow_guess = 2500.0
                if mission_range == 190 and cruise_speed == 100:
                    mtow_guess = 1500.0
                if mission_range == 100 and cruise_speed == 130:
                    mtow_guess = 1500.0
                if mission_range == 30 and cruise_speed == 200:
                    mtow_guess = 1500.0
...
if run_with_speed_as_design_var_all_opt:
    ...
    for i, mission_range in enumerate(range_array):
        ...
        if battery_energy_density == 250:
            if mission_range in [50, 70, 80, 90, 100, 110, 120, 130]:
                mtow_guess = 1500.0
            elif mission_range in [180]:
                mtow_guess = 5000.0
            elif mission_range in [190]:
                mtow_guess = 7500.0
            else:
                mtow_guess = 1000.0
        elif battery_energy_density == 400:
            if mission_range in [210, 220]:
                mtow_guess = 2000.0
            elif mission_range in [90, 100, 110, 130, 140, 150, 160, 170, 180, 190]:
                mtow_guess = 1500.0
            else:
                mtow_guess = 1000.0
        elif battery_energy_density == 550:
            if mission_range in [100, 140, 150, 160, 170, 180, 200, 210, 220]:
                mtow_guess = 1500.0
            elif mission_range in [190]:
                mtow_guess = 2000.0
            else:
