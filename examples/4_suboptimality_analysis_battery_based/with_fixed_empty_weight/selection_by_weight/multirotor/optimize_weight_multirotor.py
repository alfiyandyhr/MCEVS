...
if do_plot_objective:
    ...
    opt_results.loc[opt_results['LiftRotor|Cruise|T_to_P'] > 12.01, 'Weight|takeoff'] = np.nan
    opt_results.loc[opt_results['LiftRotor|HoverDescent|T_to_P'] > 12.01, 'Weight|takeoff'] = np.nan
    opt_results.loc[opt_results['LiftRotor|Cruise|mu'] > 1, 'Weight|takeoff'] = np.nan
    opt_results.loc[opt_results['LiftRotor|Cruise|CT/sigma'] > 0.141, 'Weight|takeoff'] = np.nan
