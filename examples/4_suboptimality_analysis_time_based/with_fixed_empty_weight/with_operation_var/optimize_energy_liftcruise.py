        ...
        for j, year1 in enumerate(year_list):
            ...
            for k, year2 in enumerate(year_list):
                ...
                if year1 in selected_years and year1 <= year2:
                    ...
                    # GTOW Analysis (with optimized operation vars)
                    problem = DesignProblem(vehicle, mission, solution_fidelity, 'GTOWSingleObjectiveProblem', 'gradient-based')
