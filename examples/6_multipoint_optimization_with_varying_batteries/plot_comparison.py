...
if plot_objective_all or plot_objective_separately or plot_constraint_separately:
	...
	opt_results_list = []
	opt_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_weight/multirotor/optimization_results.csv'))
	opt_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_energy/multirotor/optimization_results.csv'))
	opt_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_weight/liftcruise/optimization_results.csv'))
	opt_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_energy/liftcruise/optimization_results.csv'))
	test_results_list = []
	test_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_weight/multirotor/test_results.csv'))
	test_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_energy/multirotor/test_results.csv'))
	test_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_weight/liftcruise/test_results.csv'))
	test_results_list.append(pd.read_csv('../4_suboptimal_performance_evaluation/selection_by_energy/liftcruise/test_results.csv'))
	multipoint_test_results_list = []
	multipoint_test_results_list.append(pd.read_csv('weighted_sum_of_takeoff_weight/multirotor/multipoint_test_results.csv'))
	multipoint_test_results_list.append(pd.read_csv('weighted_sum_of_energy/multirotor/multipoint_test_results.csv'))
	multipoint_test_results_list.append(pd.read_csv('weighted_sum_of_takeoff_weight/liftcruise/multipoint_test_results.csv'))
	multipoint_test_results_list.append(pd.read_csv('weighted_sum_of_energy/liftcruise/multipoint_test_results.csv'))
	...
	if plot_objective_separately:
		...
		for i,metric in enumerate(metrics):
			for j,config in enumerate(configs):
				...
				plt.plot(opt_results['battery_energy_density'], opt_results[metric], 'k--', ms=4.0, label=f'Optimized at test battery GED')
