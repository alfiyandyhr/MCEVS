...
if do_optimizaton:
	...
	for i, coeff_type in enumerate(weight_coeffs_options):
		...
		if coeff_type == 'uniform':
			mtow_guess_list = [2000.0, 1700.0, 1500.0, 1200.0]
		elif coeff_type == 'linear':
			mtow_guess_list = [2200.0, 1900.0, 1700.0, 1300.0]
...
if do_test:
	...
	opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/with_fixed_empty_weight/selection_by_weight/liftcruise/optimization_results.csv')
...
if do_plot_objective:
	...
	opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/with_fixed_empty_weight/selection_by_weight/liftcruise/optimization_results.csv')
	test_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/with_fixed_empty_weight/selection_by_weight/liftcruise/test_results.csv')
	...
	plt.plot(opt_results['battery_energy_density'], opt_results['Weight|takeoff'], 'k--', label=f'Optimized at test battery GED')	
