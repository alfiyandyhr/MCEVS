...
if do_optimizaton:
    ...
    for i, coeff_type in enumerate(weight_coeffs_options):
        ...
        if coeff_type == 'uniform':
            ...
            mtow_guess_list = [1050.0, 1050.0, 1050.0, 1050.0]
...
if do_test:
    ...
    opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/liftcruise/optimization_results.csv')
...
if do_plot_objective:
    ...
    opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/liftcruise/optimization_results.csv')
    test_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/liftcruise/test_results.csv')
