...
if do_test:
	...
	opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/multirotor/optimization_results.csv')
...
if do_plot_objective:
	opt_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/multirotor/optimization_results.csv')
	test_results = pd.read_csv('../../../../4_suboptimal_performance_evaluation/without_fixed_empty_weight/selection_by_energy/multirotor/test_results.csv')
