...
optimal_plan_years = {'conservative': [2030, 2037, 2045, 2056, 2070],
					  'nominal': [2030, 2036, 2044, 2055, 2070],
					  'aggresive': [2030, 2036, 2044, 2054, 2070]} # GA-searched spacing
...
if optimize_plan:
	...
	scenario = 'conservative'; design_year = 2034
	# scenario = 'nominal'; design_year = 2034
	# scenario = 'aggresive'; design_year = 2035
