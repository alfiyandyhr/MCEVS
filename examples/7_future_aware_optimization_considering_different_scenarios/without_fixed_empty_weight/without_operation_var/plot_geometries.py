...
for scenario in scenario_list:
	...
	if scenario == 'conservative': year_list = [2030, 2044, 2070]
	if scenario == 'nominal': year_list = [2030, 2043, 2070]
	if scenario == 'aggresive': year_list = [2030, 2041, 2070]
	...
	for year in year_list:
		...
		# Building lists
		if year in [2030, 2070]: obj_label = f'Opt in {year}'
		else: obj_label = fr'Min $\psi$ ({year})'
