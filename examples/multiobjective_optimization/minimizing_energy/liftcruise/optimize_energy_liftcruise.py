	...
	for i, mission_range in enumerate(range_array):
		...
		if mission_range in [70]:
			...
			if battery_energy_density == 250:
				...
				elif mission_range in [70]: mtow_guess = 1350.0
				elif mission_range in [50,190]: mtow_guess = 1500.0
				elif mission_range in [140,220]: mtow_guess = 1650.0
				elif mission_range in [150,170,200]: mtow_guess = 1700.0
				elif mission_range in [100,160]: mtow_guess = 1750.0
