...
if __name__ == '__main__':
	...
	prob.model.add_constraint('Rotor|Ct', lower=0.0, upper=0.14 * evtol_params['rotor_cruise_solidity'])
	# CL_max at cruise = 0.6
	prob.model.add_constraint('Aero|CL_cruise', lower=0.0, upper=0.6)
	...
	print('  thrust coefficient/solidity:', list(prob.get_val('Rotor|Ct')/evtol_params['rotor_cruise_solidity']))
