...
for i, case in enumerate(driver_cases):
	...
	dv3 = cur_case.get_design_vars()['eVTOL|AR_wing'][0]
	dv4 = cur_case.get_design_vars()['Rotor|radius_lift'][0]
	dv5 = cur_case.get_design_vars()['Rotor|radius_cruise'][0]
	dv6 = cur_case.get_design_vars()['Rotor|J'][0]
...
if plot_all:
	ylabels = ['Wing area [m2]', 'Wing aspect ratio', 'Rotor radius lift [m]',
			   'Rotor radius cruise [m]', 'Propeller advance ratio',
