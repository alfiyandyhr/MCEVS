...
if plot_multi_range_optimal_speed:
	...
	data_df = pd.read_csv(f'multirotor/battery_{battery_energy_density}_Whpkg/results_with_speed_as_design_var.csv')
	data_df2 = pd.read_csv(f'liftcruise/battery_{battery_energy_density}_Whpkg/results_with_speed_as_design_var.csv')
...
if plot_multi_range_single_speed:
	...
	data_df = pd.read_csv(f'multirotor/battery_{battery_energy_density}_Whpkg/results_without_speed_as_design_var.csv')
