...
if plot_objective_all or plot_objective_separately or plot_constraint_separately:
	...
	opt_results_list = []
	opt_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_weight/multirotor/optimization_results.csv'))
	opt_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_energy/multirotor/optimization_results.csv'))
	opt_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_weight/liftcruise/optimization_results.csv'))
	opt_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_energy/liftcruise/optimization_results.csv'))
	test_results_list = []
	test_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_weight/multirotor/test_results.csv'))
	test_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_energy/multirotor/test_results.csv'))
	test_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_weight/liftcruise/test_results.csv'))
	test_results_list.append(pd.read_csv(f'../4_suboptimality_analysis_battery_based/{folder}/selection_by_energy/liftcruise/test_results.csv'))
