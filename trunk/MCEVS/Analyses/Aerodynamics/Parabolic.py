...
class WingedCruiseDrag(om.ExplicitComponent):
	...
	def compute_partials(self, inputs, partials):
		...
		partials['Aero|total_drag', 'Mission|cruise_speed'] = (dD_dCD*dCD_dCL*dCL_dq + dD_dq) * dq_dv
		partials['Aero|CL_cruise', 'Aero|Cd0'] = 0
		partials['Aero|CL_cruise', 'Aero|lift'] = dCL_dL
		partials['Aero|CL_cruise', 'Wing|area'] = dCL_dS
		partials['Aero|CL_cruise', 'Wing|aspect_ratio'] = 0
		partials['Aero|CL_cruise', 'Mission|cruise_speed'] = dCL_dq * dq_dv
