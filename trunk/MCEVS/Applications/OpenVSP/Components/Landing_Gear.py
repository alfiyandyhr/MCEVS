...
def NASA_QR_Landing_Gear(l_strut=0.3048, l_fuse=21.0, d_fuse_max=6.745500):

	# Nose, left, right
	X_Rel_Locs = [  0.250000,  0.669739,  0.669739 ]
	Y_Rel_Locs = [  0.000000, -0.700000,  0.700000 ]
	Z_Rel_Locs = [ -0.053347, -0.037689, -0.037689 ]
	Height	   = [  6.000000,  6.638240,  6.638240 ]
	p_height   = [  0.880000,  0.800000,  0.800000 ]
	Width      = [  6.259090,  6.259091,  6.259091 ]
