...
def run_gradient_free_optimization(DP: object):
    ...
    for i, dv_name in enumerate(DP.design_variables):
        if dv_name == 'Mission|cruise_speed':
            dv_names.append('cruise_speed')
        elif dv_name == 'Wing|area':
            dv_names.append('wing_area')
        elif dv_name == 'Wing|aspect_ratio':
            dv_names.append('wing_aspect_ratio')
        elif dv_name == 'LiftRotor|radius':
            dv_names.append('r_lift_rotor')
        elif dv_name == 'Propeller|radius':
            dv_names.append('r_propeller')
        elif dv_name == 'Propeller|advance_ratio':
            dv_names.append('propeller_advance_ratio')
