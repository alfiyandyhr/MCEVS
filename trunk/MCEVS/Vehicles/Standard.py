...
def StandardMultirotorEVTOL(design_var:dict, mtow=None):
	...
	vehicle.add_component(kind='lift_rotor', n_rotor=7, n_blade=4, solidity=0.13, radius=r_lift_rotor, figure_of_merit=0.75, technology_factor=0.8)
...
def StandardLiftPlusCruiseEVTOL(design_var:dict, mtow=None):
	...
	vehicle.add_component(kind='propeller', n_propeller=1, n_blade=4, solidity=0.13, radius=r_propeller, figure_of_merit=0.75, technology_factor=0.8)
