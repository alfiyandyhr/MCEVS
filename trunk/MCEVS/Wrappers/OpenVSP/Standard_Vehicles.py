...
def create_NASA_QuadRotor_vsp3(fname:str, vehicle:object):
	...
	rotor_ids = NASA_QR_Lift_Rotor(n_lift_rotor=n_lift_rotor, r_lift_rotor=r_lift_rotor, r_hub=r_hub, n_blade=n_blade_rotor, l_fuse=l_fuse, d_fuse_max=d_fuse_max, boom_ids=boom_ids)
